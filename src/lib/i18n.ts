...
export const translations = {
  ...
  es: {
    ...
    failedToGenerateSuggestions:
      "Error al generar sugerencias de subtareas. Por favor, inténtalo de nuevo.",
    networkError:
  ...
  fr: {
    ...
    appSubtitle:
      "Organisez vos tâches avec des suggestions de sous-tâches alimentées par IA",
    ...
    failedToGenerateSuggestions:
      "Échec de la génération de suggestions de sous-tâches. Veuillez réessayer.",
    networkError:
  ...
  de: {
    ...
    appSubtitle:
      "Organisieren Sie Ihre Aufgaben mit KI-gestützten Unteraufgaben-Vorschlägen",
    ...
    apiQuotaExceeded:
      "API-Kontingent überschritten. Bitte versuchen Sie es später erneut.",
    failedToGenerateSuggestions:
